            ...
            <div class="row">
                <div class="col-12">
                    <div class="d-flex align-items-center my-5">
                        <div class="my-5">
                            <h1 class="Hero-h1 mb-0">تحذيرات النصب من شركات التداول</h1>
                            <p class="Hero-p my-3">موقع تدقيق يوفر تحذيرات مستمرة وموثوقة حول شركات التداول النصابة، بهدف
                                حماية المتداولين العرب
                                وتمكينهم من اتخاذ قرارات استثمارية آمنة، حيث يتم مراقبة ومراجعة الشركات المشبوهة وإصدار
                                تحذيرات تفصيلية تساعد المستثمرين في تجنب التعامل معها، وبذلك يسهم الموقع في تحقيق الأمان
                                والحماية في عالم التداول المالي.</p>
                        </div>
                    </div>
                </div>
            </div>
